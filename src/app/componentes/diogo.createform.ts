...
import { EntityType, PropertyType, TitleCase, EntityTypeComponent, FlashMessageService, AngularmService } from 'angularm';
...
export class DiogoCreateEntityComponent extends EntityTypeComponent implements OnInit {
